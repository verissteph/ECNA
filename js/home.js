...
ourRequest.onload = function () {
  ...
  precoRespontivo.innerHTML = 'R$' + (btcLastPrice * 5).toFixed(2)
  ...
  MaisAlto.innerHTML = 'R$' + (precoMaisAlto * 5).toFixed(2)

  let MaisAltoR = document.getElementById("maisAlto-r")
  MaisAltoR.innerHTML = 'R$' + (precoMaisAlto * 5).toFixed(2)
  ...
  MaisBaixo.innerHTML = 'R$' + (precoMaisBaixo * 5).toFixed(2)

  let MaisBaixoR = document.getElementById("maisBaixo-r")
  MaisBaixoR.innerHTML = 'R$' + (precoMaisBaixo * 5).toFixed(2)
